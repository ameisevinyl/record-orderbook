...
async function handleFile(side, file){
  ...
  if(kind === "pdf"){
    ...
    // the iframe with it present; Chrome/Firefox already fill correctly
    // via the CSS width/height:100% on .label-preview iframe regardless
    // of this fragment, so dropping it is safe for them.
